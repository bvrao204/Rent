...
const INITIAL_PRODUCTS = [
  ...
  {
    id: 'prod-19',
    name: 'Whirlpool 340L Frost Free Double Door Refrigerator',
    category: 'appliance',
    subCategory: 'fridge',
    baseRent: 1269,
    securityDeposit: 4409,
    rating: 4.7,
    reviewsCount: 22,
    stock: 5,
    features: ['Adaptive Intelligence technology', 'Convertible 5-in-1 modes', 'IntelliSense Inverter Technology', 'Zeolite technology to prevent over-ripening'],
    description: 'Experience powerful cooling and long-lasting freshness. This Whirlpool double door fridge automatically adjusts cooling based on load and outside temperature.'
  },
  {
    id: 'prod-20',
    ...
    subCategory: 'ac',
    baseRent: 1439,
    securityDeposit: 5669,
    rating: 4.8,
    reviewsCount: 39,
    stock: 6,
    features: ['Neo Swing Compressor', 'PM 2.5 Filter', 'Dew clean technology', 'Coanda Airflow', 'Triple Display'],
    description: 'Stay cool and breathe fresh air. Daikin\'s advanced inverter technology ensures rapid cooling, minimal noise, and superior energy efficiency for your home.'
  },
  {
    id: 'prod-21',
    name: 'Bosch 7 kg 5 Star Inverter Front Load Washing Machine',
    category: 'appliance',
    subCategory: 'washing-machine',
    baseRent: 1069,
    securityDeposit: 3779,
    rating: 4.9,
    reviewsCount: 61,
    stock: 4,
    features: ['EcoSilence Drive', 'Anti-Tangle Technology', 'ActiveWater Plus', 'Anti-Vibration Side Panels', 'SpeedPerfect'],
    description: 'Protect your clothes while getting the perfect wash. Bosch\'s German engineering provides ultra-quiet operation and gentle fabric care without compromising on stain removal.'
  },
  {
    id: 'prod-22',
    ...
    subCategory: 'microwave',
    baseRent: 699,
    securityDeposit: 1469,
    rating: 4.5,
    reviewsCount: 17,
    stock: 11,
    features: ['Zero Oil Cooking', 'Magic Grill', 'Vapor Clean', '101 Auto Cook Menus', 'Compact Design'],
    description: 'Elevate your culinary skills. This Panasonic microwave offers versatile convection cooking and oil-free frying so you can enjoy healthy, delicious meals effortlessly.'
  },
  {
    id: 'prod-23',
    name: 'Eureka Forbes Aquaguard Aura RO+UV+UF+MTDS',
    category: 'appliance',
    subCategory: 'water-purifier',
    baseRent: 629,
    securityDeposit: 1129,
    rating: 4.7,
    reviewsCount: 44,
    stock: 16,
    features: ['Active Copper Technology', 'Mineral Guard Technology', 'Taste Adjuster (MTDS)', 'UV e-boiling', '7L Storage Capacity'],
    description: 'Ensure 100% safe drinking water for your family. The Aquaguard Aura infuses copper ions and retains essential natural minerals, providing healthy and tasty water from any source.'
  },
  {
    id: 'prod-24',
    name: 'Crompton Amica 15-Litre Storage Water Heater',
    category: 'appliance',
    subCategory: 'geyser',
    baseRent: 509,
    securityDeposit: 589,
    ...
    reviewsCount: 28,
    stock: 9,
    features: ['Advanced 3-level safety', 'Nano Polybond Technology', 'Heavy Duty Magnesium Anode', 'Smart Energy Management', 'Standby cut-off'],
    description: 'Enjoy hot showers instantly. Crompton\'s powerful water heater ensures quick heating, excellent heat retention, and complete safety against hard water corrosion.'
  },
  {
    id: 'prod-25',
    name: 'Wakefit Orthopedic King Size Bed',
    category: 'furniture',
    subCategory: 'bed',
    baseRent: 1159,
    securityDeposit: 3569,
    rating: 4.8,
    reviewsCount: 45,
    stock: 8,
    features: ['Premium Teak Wood Finish', 'Ergonomic Headboard', 'Dual Hydraulic Storage', 'Water Resistant Polish'],
    description: 'Transform your bedroom into a luxurious sanctuary. This king-size bed combines robust engineering wood with a gorgeous teak finish, featuring hydraulic lift storage for all your extra bedding.'
  },
  {
    id: 'prod-26',
    name: 'IKEA Malm Minimalist Queen Bed',
    category: 'furniture',
    subCategory: 'bed',
    baseRent: 899,
    securityDeposit: 2219,
    rating: 4.6,
    reviewsCount: 31,
    stock: 12,
    features: ['Scandinavian Minimalist Design', 'White Stained Ash Veneer', 'Adjustable Bed Sides', 'Sturdy Slatted Base'],
    description: 'Bring clean, Scandinavian styling into your space. The sleek, low-profile design fits seamlessly into modern apartments, offering exceptional support and comfort.'
  },
  {
    id: 'prod-27',
    name: 'Casablanca L-Shaped Sectional Sofa',
    category: 'furniture',
    subCategory: 'sofa',
    baseRent: 1299,
    securityDeposit: 4199,
    ...
    reviewsCount: 78,
    stock: 5,
    features: ['L-Shape Configuration', 'Premium Suede Fabric', 'High-Resiliency Foam', 'Removable Washable Covers'],
    description: 'The ultimate lounge experience. This massive sectional sofa provides seating for the whole family, featuring ultra-soft suede upholstery and sink-in comfort.'
  },
  {
    id: 'prod-28',
    name: 'Godrej Interio 2-Seater Leatherette Sofa',
    category: 'furniture',
    subCategory: 'sofa',
    baseRent: 809,
    securityDeposit: 1889,
    rating: 4.5,
    reviewsCount: 19,
    stock: 9,
    features: ['Compact Space-saving Design', 'Premium Faux Leather', 'Anti-sag Spring System', 'Solid Wood Frame'],
    description: 'Perfect for studio apartments or reading corners. A highly durable faux leather sofa that easily wipes clean, resisting scratches and stains.'
  },
  {
    id: 'prod-29',
    name: 'Durian 6-Seater Glass Top Dining Table',
    category: 'furniture',
    subCategory: 'table',
    baseRent: 989,
    securityDeposit: 2939,
    rating: 4.7,
    reviewsCount: 26,
    stock: 7,
    features: ['Tempered Glass Top', 'Rust-proof Steel Legs', 'Includes 6 Cushioned Chairs', 'Spacious Leg Room'],
    description: 'Dine in contemporary elegance. A stunning combination of thick tempered glass and polished steel that makes your dining area feel larger and brighter.'
  },
  {
    id: 'prod-30',
    name: 'Pepperfry Solid Sheesham Wood Table',
    category: 'furniture',
    subCategory: 'table',
    baseRent: 899,
    securityDeposit: 2519,
    ...
    reviewsCount: 52,
    stock: 4,
    features: ['100% Solid Sheesham Wood', 'Warm Honey Finish', 'Seats 4 Adults', 'Termite Resistant'],
    description: 'A classic, rustic dining table built to last a lifetime. Handcrafted from premium Indian rosewood, bringing natural warmth and grain patterns to your home.'
  }
];
...
export const DataProvider = ({ children }) => {
  ...
  const [products, setProducts] = useState(() => {
    const saved = localStorage.getItem('rentease_products_v4');
  ...
  useEffect(() => {
    localStorage.setItem('rentease_products_v4', JSON.stringify(products));
  }, [products]);
